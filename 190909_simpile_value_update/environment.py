...
class GraphicDisplay(tk.Tk):
    def __init__(self, agent):
        ...
        self.title('Grid System Introduction')
    ...
    def _build_canvas(self):
        ...
        # --"move button"
        move_button = tk.Button(self, text="Move", command=self.move_by_policy)
    ...
    def load_images(self):
        ...
        return (up, down, left, right), (dog, rock, meat)
